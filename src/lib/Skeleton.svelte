<div class="container">
  <div class="skeleton-container">
    <div class="skeleton-header-container">
      <div class="skeleton skeleton-text pulsate" />
      <div class="skeleton skeleton-header pulsate" />
    </div>
    <div class="skeleton skeleton-box pulsate" />
    <div class="skeleton skeleton-text pulsate" />
    <div class="skeleton skeleton-box pulsate" />
    <div class="skeleton skeleton-box pulsate" />
  </div>
...
<style>
  ...
  .pulsate {
    ...
    animation: Gradient 2.25s ease-in-out infinite;
  }
